...
for sc in $scans;  do
  ...
  echo "$singularity run -B /data/joy/BBL/studies/ptsd/rawData:/home/${user}/data /data/joy/BBL/applications/heudiconv/heudiconv-latest.simg -d /home/${user}/data/{subject}/{session}/* -o /home/${user}/data/joy/BBL/studies/ptsd/BIDS/ -f /home/${user}/projects/ptsd_heur_day2.py -s ${subID} -ss ${ses}  -c dcm2niix -b --overwrite" > ~/${ses}_${subID}_singl.sh
...
for sc in $scans;  do
  ...
  singularity=/share/apps/singularity/2.5.1/bin/singularity
  # USE SINGULARITY HERE TO RUN HEUDICONV FOR BIDS FORMATTING
  echo "$singularity run -B /data/joy/BBL/studies/ptsd/rawData:/home/${user}/data /data/joy/BBL/applications/heudiconv/heudiconv-latest.simg -d /home/${user}/data/{subject}/{session}/* -o /home/${user}/data/joy2/BBL/studies/ptsd/BIDST1/ -f /home/${user}/projects/nrco_bids/ptsd_heur-T1.py -s ${subID} -ss ${ses}  -c dcm2niix -b --overwrite" > ~/${ses}_${subID}_T1singl.sh
