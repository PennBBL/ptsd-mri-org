...
for idw in `find /data/joy/BBL/studies/ptsd/BIDS/sub-DM* -mindepth 1 -maxdepth 1 | rev | cut -f 2 -d / | rev | cut -f 2 -d - | uniq` ; do
  ...
  echo /share/apps/singularity/2.5.1/bin/singularity run -B /data:/home/arosen/data /data/joy/BBL/applications/bids_apps/freesurfer.simg /home/arosen/data/joy/BBL/studies/ptsd/BIDS/  /home/arosen/data/joy/BBL/studies/ptsd/processedData/anatomical/freesurfer60/ participant --participant_label ${idw} --license_file /home/arosen/data/joy/BBL/studies/ptsd/processedData/anatomical/freesurfer60/license.txt  --skip_bids_validator > subjectrun${idw}.sh

  qsub  -q all.q,basic.q -l h_vmem=8.0G,s_vmem=8.0G  subjectrun${idw}.sh ;
...
for idw in `find /data/joy/BBL/studies/ptsd/BIDST1/sub-DM* -mindepth 1 -maxdepth 1 | rev | cut -f 2 -d / | rev | cut -f 2 -d - | uniq` ; do
  ...
  qsub  -q all.q,basic.q -l h_vmem=8.0G,s_vmem=8.0G  subjectrunFSCS${idw}.sh ;
